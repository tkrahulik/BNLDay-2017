...
{\textsc{\textbf{Thomas Krahulik}, \textbf{Joshua LaBounty}, Dr. Abhay Deshpande, Dr. Nils Feege, et. al. \\ Stony Brook University, Department of Physics and Astronomy \\ Brookhaven National Laboratory $\bullet$ Argonne Nation al Laboratory}}% Author names and institution
...
A superconductor naturally expels magnetic field lines through the Meissner effect, while a ferromagnet pulls them in. By combining the two effects, one can achieve a field free region in the center while keeping the outside field undisturbed.
...
Superconductors, when cooled below their critical temperature ($T_{c}$), expel magnetic fields through the Meissner effect. To construct our shield, we use Yttrium Barium Copper Oxide (YBCO) tape from American Superconductor, which consists of a thin layer of YBCO attached to a Nickel backing and coated with a thin layer of Silver to prevent corrosion. Here, we show that multiple layers of this tape, shaped into cylinders, can be used as an effective means to shield the inside of the structure from an external field. We also show that the shielding of this system can be increased by adding of more layers.
...
\begin{center}
\includegraphics[width=0.93\linewidth]{bnl_beam.jpg}
...
Gomory, F., et al., \textit{Experimental Realization of a Magnetic Cloak}. DOI: 10.1126/science.1218316
...
Superconductors alone can create a field-free region in the interior of the cylinder, but distort the external field (Figure \ref{fig:distortions}). For particle accelerators, where a uniform field is desired for momentum measurements of charged particles, this is not an ideal situation. By adding a carefully tuned ferromagnet concentric with the superconductor, we show that we can reduce the distortions by $90\%$ (Figure \ref{fig:cloak}).
